# DS Template v6 — Kaggle Competition Workspace
...
- **v6 / v6.1 / v6.2**: ドキュメント階層の再設計（4層モデル + SSoT と規律の機械検証）

---

## v6 で追加された主な改善 — ドキュメント階層の再設計
...
| **C4** | **実測値の保存**（固定 35 個の数値が消えたら ERROR）|
...
> 数値の grep なら 100% 検知できる。今回の再編で **35/35 を一度も落とさずに完了した**。
...
| | v5 | v6 |
|---|---|---|
| **常時ロード**（CLAUDE.md + `.claude/rules/`） | **1,223 行** | **639 行（-48%）** |
